                    ...
                    <div class="form-horizontal" id="payorder_search">
                        <div class="row-fluid label-colon">
                            <div class="control-group span6" id="business-type-selector">
                                ...
                                <div class="controls">
                                    <select id="businesstype" name="businessType" class="form_value"
                                            validate="ne[0]"
                        ...
                        <div class="row-fluid label-colon">
                            <div class="control-group span6">
                                ...
                                <div class="controls">
                                    ...
                                    至
                                    <div class="input-append">
                                        <input type="text" id="addenddate" validate="ge[addbegindate]"
                                               datatype="date"
                ...
                <div class="body strip">
                    <div>
                        <div class="alert alert-warning" id="select-all-pageinfo">
                            已勾选本页全部数据， <a href="#" id="select-all-page">点击这里勾选全部</a>&nbsp;<i
                                class="recordCount"></i> 条
                        </div>
                        ...
                        <div class="alert alert-info" id="result-info">
                            ...
                            &nbsp;&nbsp;
                            <a id="pay-success" class="btn btn-primary btn-fs-normal btn-fs-sm ajaxdisabledbutton"
                               href="#"
                               style="display: none">
